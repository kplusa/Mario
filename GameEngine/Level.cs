        ...
        public void LoadMap(string filename, int levelId)
        {
            ...
            { 
                ...
                for (int y = 0; y < Columns; y++)
                {
                    ...
                    if (tile.Resource != "")
                        ResourceManager.GetInstance().LoadTexture(tile.Resource, @"resources\" + tile.Resource + ".png");


                    if(tile.Entity != "")
                    {
                        ResourceManager.GetInstance().LoadSpriteSheetFromFile(tile.Entity, @"resources\" + tile.Resource + ".png", tile.Frames);
                    }
